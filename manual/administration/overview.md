...
The system admin user is a special user that does not belong to any team and cannot use normal features of SeaTicket. It can only access the system adminitration interface.
